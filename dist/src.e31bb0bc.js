...
var CONTRACT_NAME = 'plat.dungho.testnet';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/dungho", "/.near/validator_key.json"),
...
var nearUtils = utils;
exports.nearUtils = nearUtils;
var DEFAULT_GAS = 300000000000000; // global variable used throughout
...
document.querySelector('#sign-out-button').onclick = _utils.logout; //Deposit 

document.querySelector('form#deposit').onsubmit = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            amount = event.target.elements.deposit.value;
            _context2.prev = 3;
            _context2.next = 6;
            return window.contract.deposit({
              game_id: 1
            }, DEFAULT_GAS, nearUtils.format.parseNearAmount(amount));
...
document.querySelectorAll('input#deposit').forEach(function (elem) {
  elem.oninput = function (event) {
    var submitButton = elem.parentElement.querySelector('button');
